 ...
 * @author yessi
 */
public class EDITENTRY2 extends javax.swing.JFrame {
    ...
    public EDITENTRY2(Long fuelID) {
        ...
        if(checkAmount == true && checkCost == true){
            ...
            AtlantisFuel.editEntry(fuelID, username, /*dayEnterred, monthEnterred, yearEnterred, */fuelType, fuelAmount, cost, dateEnterred, vehicleName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EDITENTRY2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EDITENTRY2(fuelID).setVisible(true);
            }
        });
    }
